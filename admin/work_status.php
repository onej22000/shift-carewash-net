...
// 方式に置き換えた。staff/work_status.phpと同じロジック）。
...
<?php else: ?>
    ...
    <p class="notice">未完了数は洗濯ネット数から洗濯累計を差し引いたものです。このサイクルに対応する作業登録（collection_headcount.php）が完了すると「完了」になります。発送入力済みの分は表示されません。</p>
<?php endif; ?>
</body>
</html>
