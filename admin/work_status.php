...
<?php else: ?>
    ...
    <p class="notice">リネン袋数は従業員の「集荷・配送記録を入力する」画面で記録された集荷リネン袋数の合計（参考値、他の数値には影響しません）。集荷人数は「集荷人数の確認」画面での確認記録に基づきます。未完了数は集荷人数から洗濯累計を差し引いたものです（洗濯・乾燥・畳みは2026-08-06に「洗濯」1工程へ統合済み）。</p>
<?php endif; ?>
</body>
</html>
